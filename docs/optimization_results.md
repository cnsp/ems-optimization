...
- **Improvement over uniform baseline**: 17-86% faster response time
...
|----|------|------|-------------|
| **P0** | Uniform | Baseline | Equal distribution across all 48 firehouses |
...
- Firehouse capacity: max 5 units per location
...
|---|--------|---------------------|--------------|-----------------|-----------|------------------|
| **20** | P0 | 18.55 | 73.0 | 20 | 1 | 0.00 |
| 20 | P1 | 2.87 | 100.0 | 18 | 2 | 0.00 |
| 20 | **P2** | **2.54** | **100.0** | 20 | 1 | 0.04 |
| 20 | P2b | 2.54 | 100.0 | 20 | 1 | 0.04 |
| 20 | P2c | 3.48 | 100.0 | 7 | 5 | 0.01 |
| **30** | P0 | 7.00 | 92.0 | 30 | 1 | 0.00 |
| 30 | P1 | 2.52 | 100.0 | 21 | 3 | 0.00 |
| 30 | **P2** | **2.49** | **100.0** | 23 | 5 | 0.04 |
| 30 | P2b | 2.49 | 100.0 | 30 | 1 | 0.04 |
| 30 | P2c | 3.48 | 100.0 | 8 | 5 | 0.01 |
| **40** | P0 | 3.02 | 100.0 | 40 | 1 | 0.00 |
| 40 | P1 | 2.52 | 100.0 | 21 | 4 | 0.00 |
| 40 | **P2** | **2.49** | **100.0** | 24 | 5 | 0.04 |
| 40 | P2b | 2.49 | 100.0 | 40 | 1 | 0.04 |
| 40 | P2c | 3.48 | 100.0 | 10 | 5 | 0.01 |
| **48** | P0 | 2.49 | 100.0 | 48 | 1 | 0.00 |
| 48 | P1 | 2.52 | 100.0 | 21 | 5 | 0.00 |
| 48 | **P2** | **2.49** | **100.0** | 26 | 5 | 0.05 |
| 48 | P2b | 2.49 | 100.0 | 48 | 1 | 0.03 |
...
|---|---------------------------|----------------------|
| 20 | **86.3%** faster | +27.0 pp |
| 30 | **64.4%** faster | +8.0 pp |
| 40 | **17.4%** faster | 0.0 pp |
| 48 | 0.0% (tied) | 0.0 pp |

**Insight**: Optimization provides the greatest benefit when resources are scarce (K=20-30).

### 3.2 Diminishing Returns

**P0 (Uniform) - Strong diminishing returns**:
- K=20→30: 11.55 min improvement (1.16 min/unit)
- K=30→40: 3.98 min improvement (0.40 min/unit)
- K=40→48: 0.53 min improvement (0.07 min/unit)
...
**Conclusion**: **P2 achieves near-optimal performance with just K=20 units**, while P0 requires K≥40 to match.
...
- All policies achieve **100% coverage at K≥20** (except P0 at K=20)
- P0 requires **K≥40** to achieve 100% coverage
- P2/P2b achieve 100% with **50% fewer units** than P0
...
| K | P0 | P1 | P2 | Δ(P0-P2) |
|---|----|----|----|---------:|
| 20 | 18.55 | 2.87 | 2.54 | **16.01 min** |
| 30 | 7.00 | 2.52 | 2.49 | 4.51 min |
| 40 | 3.02 | 2.52 | 2.49 | 0.53 min |
