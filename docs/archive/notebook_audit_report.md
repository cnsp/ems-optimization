...
> **⚠️ Note:** This audit report documents changes made during the P0 nomenclature migration. It references old metric values (e.g., 8.08 min) to describe *what was changed*. These are not current results. See [`nomenclature_migration.md`](../core/nomenclature_migration.md).
