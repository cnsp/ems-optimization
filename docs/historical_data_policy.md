...
|------|-------------------|--------|
| `results/baseline/production_v2/simulation/all_results_raw.csv` | Yes — contains K = 10 rows where P0 RT > 4 min | **Expected** — small fleet sizes legitimately have higher RT |
| `results/tables/posthoc_comparisons.csv` | References to old statistical tests | Legacy from v1 production run; superseded by `results/baseline/production_v2/tables/` |
