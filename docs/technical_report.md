...
59. `results/baseline/production_v2/figures/mean_rt_vs_K.png` — Mean response time vs fleet size
60. `results/baseline/production_v2/figures/coverage_vs_K.png` — Coverage vs fleet size with dual standards (6-min NYC and 8-min NFPA) and 95% CI
61. `results/baseline/production_v2/figures/rt_distribution_K20.png` — Response time distributions at K=20
62. `results/baseline/production_v2/figures/utilization_vs_K.png` — Utilization vs fleet size
63. `results/baseline/production_v2/figures/effect_sizes.png` — Effect sizes across fleet sizes
64. `results/baseline/production_v2/figures/allocation_map_K20.png` — Allocation map at K=20
65. `results/baseline/production_v2/figures/allocation_map_K30.png` — Allocation map at K=30
66. `results/baseline/production_v2/figures/allocation_map_K40.png` — Allocation map at K=40
...
| # | Filename | Description |
|---|----------|-------------|
| 33 | `results/baseline/production_v2/tables/descriptive_statistics.csv` | Descriptive statistics (cap=2) |
| 34 | `results/baseline/production_v2/tables/anova_results.csv` | ANOVA results |
| 35 | `results/baseline/production_v2/tables/posthoc_comparisons.csv` | Pairwise comparisons |
| 36 | `results/baseline/production_v2/tables/confidence_intervals.csv` | 95% confidence intervals |
| 37 | `results/baseline/production_v2/tables/effect_sizes.csv` | Cohen's d effect sizes |
| 38 | `results/baseline/production_v2/tables/queue_statistics.csv` | Queue statistics |
| 39 | `results/baseline/production_v2/comparison_with_v1.csv` | Baseline comparison table |
