...
Default output: results/analysis/figures/project_summary_dashboard.png
...
def main():
    parser = argparse.ArgumentParser(description="Generate project summary dashboard")
    ...
    OUT = os.path.join(out_dir, "project_summary_dashboard.png")
