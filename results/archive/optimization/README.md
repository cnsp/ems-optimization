...
The capacity default was later changed from 5 → 2 (DEC-010) based on sensitivity analysis.

## What's Here
- **Allocations** at K=15,20,25,30,35,40,48 with cap=5
- **Policy comparison** across P0, P1, P2, P2b, P2c
- **Phase 3 summary report**

## Why Keep It?
- Documents the Phase 3 milestone
- Useful for comparing cap=5 vs cap=2 outcomes
- The directional conclusions (P2 dominates) remain valid
